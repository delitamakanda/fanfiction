<template>
    <div :id="'toast-' + type"
        ...
        <div class="inline-flex flex-shrink-0 justify-center items-center w-8 h-8  rounded-lg "
            :class="{ 'text-green-500 bg-green-100 dark:bg-green-800 dark:text-green-200': type === 'success', 'text-red-500 bg-red-100 dark:bg-red-800 dark:text-red-200': type === 'danger', 'text-orange-500 bg-orange-100 dark:bg-orange-700 dark:text-orange-200': type === 'warning', 'text-gray-500 divide-x divide-gray-200 dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800': type === 'info' }">
