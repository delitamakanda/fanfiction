    ...
    <nav class="flex items-center justify-between flex-wrap bg-white p-6 shadow">
        ...
        <div :class="open ? 'block': 'hidden'" class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            <div class="text-sm lg:flex-grow">
                ...
                <a class="block mt-4 lg:inline-block lg:mt-0 text-teal hover:text-teal-darker" href="/help/browse/title"><svgicon icon="question" width="22" height="18" color="#4dc0b5"></svgicon> Aide</a>
            </div>
        </div>
    </nav>
