    ...
    <div class="w-full flex flex-row flex-wrap">
        <div class="w-full bg-indigo-100 h-screen flex flex-row flex-wrap justify-center">
            ...
            <div class="w-0 md:w-1/4 lg:w-1/5 h-0 md:h-screen overflow-y-hidden bg-white shadow-lg">
                ...
                <router-link v-if="user && user.is_staff" class="hover:bg-gray-300 bg-gray-200 border-t-2 p-3 w-full text-xl text-left text-gray-600 font-semibold" tag="button" :to="{name: 'EditNews'}">
