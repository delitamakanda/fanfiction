...
urlpatterns = [
    ...
    path('fanfics/classement', views.ClassementListView.as_view(), name='classement-list'),
    path('fanfics/status', views.StatusListView.as_view(), name='status-list'),
    ...
    path('user/<str:user__username>/profile', views_user.AccountProfileListView.as_view(), name='user-account-profile'),
    path('user/<int:account>/socialaccount', views_user.SocialListView.as_view(), name='socialaccount-view'),
    path('user/<int:user__id>/edit/profile', views_user.AccountProfileUpdateView.as_view(), name='user-edit-account-profile'),
    path('user/social-account', views_user.SocialCreateView.as_view(), name='socialaccount-createview'),
