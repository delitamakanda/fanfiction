...
urlpatterns = [
    ...
    path('fanfics/<int:pk>/detail', views_fanfic.FanficDetailView.as_view(), name='fanfic-detail'),
    path('fanfics/v1/<str:slug>/detail', views_fanfic.FanficListDetailView.as_view(), name='fanfic-list-detail'),
