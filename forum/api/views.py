...
from api.custompermission import IsTopicStarterOrReadOnly, IsMessageCreatorOrReadOnly
...
class TopicViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [permissions.IsAuthenticatedOrReadOnly, IsTopicStarterOrReadOnly]
    http_method_names = ['get', 'post', 'put', 'patch', 'delete']
...
class MessageViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [permissions.IsAuthenticatedOrReadOnly, IsMessageCreatorOrReadOnly]
    http_method_names = ['get', 'post', 'put', 'patch', 'delete']
